...
maps_config = {
    ...
    'sochi-2024': {
        'name': 'Сочи (2024)',
        'maps': {
            '1': CityMap('Приложение № 4 Карта планируемого размещения ОМЗ', '', 'sochi-2024/1'),
            '2': CityMap('Приложение № 5 Карта планируемого размещения ОМЗ', '', 'sochi-2024/2'),
            '3': CityMap('Приложение № 6 Карта планируемого размещения ОМЗ', '', 'sochi-2024/3'),
            '4': CityMap('Приложение № 7 Карта планируемого размещения ОМЗ', '', 'sochi-2024/4'),
            '5': CityMap('Приложение № 8 Карта планируемого размещения ОМЗ', '', 'sochi-2024/5'),
            '6': CityMap('Приложение № 9 Карта планируемого размещения ОМЗ', '', 'sochi-2024/6'),
            '7': CityMap('Приложение № 10 Карта планируемого размещения ОМЗ', '', 'sochi-2024/7'),
            '8': CityMap('Приложение № 11 Карта планируемого размещения ОМЗ', '', 'sochi-2024/8'),
            '9': CityMap('Приложение № 12 Карта планируемого размещения ОМЗ', '', 'sochi-2024/9'),
            '10': CityMap('Приложение № 13 Карта планируемого размещения ОМЗ', '', 'sochi-2024/10'),
            '11': CityMap('Приложение № 14 Карта планируемого размещения ОМЗ', '', 'sochi-2024/11'),
            '12': CityMap('Приложение № 15 Карта планируемого размещения ОМЗ', '', 'sochi-2024/12'),
            '13': CityMap('Приложение № 16 Карта планируемого размещения ОМЗ', '', 'sochi-2024/13'),
            '14': CityMap('Приложение № 17 Карта планируемого размещения ОМЗ', '', 'sochi-2024/14'),
            '15': CityMap('Приложение № 18 Карта планируемого размещения ОМЗ', '', 'sochi-2024/15'),
            '16': CityMap('Приложение № 19 Карта планируемого размещения ОМЗ', '', 'sochi-2024/16'),
            '17': CityMap('Приложение № 20 Карта ОМЗ автомобильные дороги', '', 'sochi-2024/17'),
            '18': CityMap('Приложение № 21 Карта ОМЗ общественный пассажирский транспорт', '', 'sochi-2024/18'),
            '19': CityMap('Приложение № 22 Карта ОМЗ в области образования', '', 'sochi-2024/19'),
            '20': CityMap('Приложение № 23 Карта ОМЗ в области спорта', '', 'sochi-2024/20'),
            '21': CityMap('Приложение № 24 Карта ОМЗ в областях культуры и искусства, молодежной политики', '', 'sochi-2024/21'),
            '22': CityMap('Приложение № 94 Карта инженерной подготовки территории', '', 'sochi-2024/22'),
            '23': CityMap('Приложение № 95 Карта ОМЗ озеленения и ООПТ', '', 'sochi-2024/23'),
            '24': CityMap('Приложение № 96 Карта границ населенных пунктов', '', 'sochi-2024/24'),
            '25': CityMap('Приложение № 97 Карта функциональных зон', '', 'sochi-2024/25'),
            '26': CityMap('Приложение № 108 Карта современного использования территории', '', 'sochi-2024/26'),
            '27': CityMap('Приложение № 109 Карта современного состояния транспортной инфраструктуры', '', 'sochi-2024/27'),
            '28': CityMap('Приложение № 110 Карта планируемых для размещения (реконструкции) объектов транспортной инфраструктуры федерального, регионального и иного значения', '', 'sochi-2024/28'),
            '29': CityMap('Приложение № 111 Карта размещения объектов соц инфраструктуры в области образования и науки', '', 'sochi-2024/29'),
            '30': CityMap('Приложение № 112 Карта размещения объектов соц инфраструктуры в областях здравоохранения и соц обслуживания', '', 'sochi-2024/30'),
            '31': CityMap('Приложение № 113 Карта размещения объектов соц инфраструктуры в областях культуры и искусства, молодежной политики', '', 'sochi-2024/31'),
            '32': CityMap('Приложение № 114 Карта размещения объектов соц инфраструктуры в области физической культуры и массового спорта', '', 'sochi-2024/32'),
            '33': CityMap('Приложение № 121 Карта границ земель различных категорий', '', 'sochi-2024/33'),
            '34': CityMap('Приложение № 122 Карта земельно имущественных отношений', '', 'sochi-2024/34'),
            '35': CityMap('Приложение № 123 Карта ЗОУИТ', '', 'sochi-2024/35'),
            '36': CityMap('Приложение № 124 Карта ОКН памятники истории и культуры', '', 'sochi-2024/36'),
            '37': CityMap('Приложение № 126 Карта геологических условий и инженерно-геологического районирования', '', 'sochi-2024/37'),
            '38': CityMap('Приложение № 127 Карта современного состояния окружающей среды', '', 'sochi-2024/38'),
            '39': CityMap('Приложение № 128 Карта размещения объектов федерального, регионального, местного и иного значения', '', 'sochi-2024/39'),
            '40': CityMap('Приложение № 129 Карта природно-рекреационного комплекса', '', 'sochi-2024/40'),
            '41': CityMap('Приложение № 130 Карта развития санаторно-курортной и туристской инфраструктур', '', 'sochi-2024/41'),
            '42': CityMap('Приложение № 131 Карта развития прибрежных территорий', '', 'sochi-2024/42'),
            '43': CityMap('Приложение № 132 Карта развития агропромышленного комплекса', '', 'sochi-2024/43'),
            '44': CityMap('Приложение № 133 Карта инвестиционных проектов', '', 'sochi-2024/44'),
            '45': CityMap('Приложение № 134 Карта территорий, подверженных риску возникновения чрезвычайных ситуаций природного и техногенного характера', '', 'sochi-2024/45'),
        }
    }
}
